    ...
    const GetSetData = () => {
        ...
        for (let movie of moviesData.data.results) {   
                ...
                try{
                    ...
                    iframe.src = "../assets/images/youtube-error.webp";
                    ...
                    document.getElementById('rem').appendChild(p);
                    document.getElementById('rem').appendChild(img);
                    document.getElementById('rem').appendChild(iframe);
                }
                });
            }
        });
